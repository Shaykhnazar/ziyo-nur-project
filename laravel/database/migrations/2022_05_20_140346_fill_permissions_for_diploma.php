...
class FillPermissionsForDiploma extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForDiploma constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.diploma',
            'admin.diploma.index',
            'admin.diploma.create',
            'admin.diploma.show',
            'admin.diploma.edit',
            'admin.diploma.delete',
            'admin.diploma.bulk-delete',
        ]);
